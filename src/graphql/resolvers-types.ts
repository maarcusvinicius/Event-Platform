...
export type ResolversTypes = {
  ...
  ChallengeConnectInput: ChallengeConnectInput;
  ChallengeConnection: ResolverTypeWrapper<ChallengeConnection>;
  ChallengeCreateInput: ChallengeCreateInput;
  ChallengeCreateManyInlineInput: ChallengeCreateManyInlineInput;
  ChallengeCreateOneInlineInput: ChallengeCreateOneInlineInput;
  ChallengeEdge: ResolverTypeWrapper<ChallengeEdge>;
  ChallengeManyWhereInput: ChallengeManyWhereInput;
  ChallengeOrderByInput: ChallengeOrderByInput;
  ChallengeUpdateInput: ChallengeUpdateInput;
  ChallengeUpdateManyInlineInput: ChallengeUpdateManyInlineInput;
  ChallengeUpdateManyInput: ChallengeUpdateManyInput;
  ChallengeUpdateManyWithNestedWhereInput: ChallengeUpdateManyWithNestedWhereInput;
  ChallengeUpdateOneInlineInput: ChallengeUpdateOneInlineInput;
  ChallengeUpdateWithNestedWhereUniqueInput: ChallengeUpdateWithNestedWhereUniqueInput;
  ChallengeUpsertInput: ChallengeUpsertInput;
  ChallengeUpsertWithNestedWhereUniqueInput: ChallengeUpsertWithNestedWhereUniqueInput;
  ChallengeWhereComparatorInput: ChallengeWhereComparatorInput;
  ChallengeWhereInput: ChallengeWhereInput;
  ChallengeWhereStageInput: ChallengeWhereStageInput;
  ...
  LessonConnectInput: LessonConnectInput;
  LessonConnection: ResolverTypeWrapper<LessonConnection>;
  LessonCreateInput: LessonCreateInput;
  LessonCreateManyInlineInput: LessonCreateManyInlineInput;
  LessonCreateOneInlineInput: LessonCreateOneInlineInput;
  LessonEdge: ResolverTypeWrapper<LessonEdge>;
  LessonManyWhereInput: LessonManyWhereInput;
  LessonOrderByInput: LessonOrderByInput;
  LessonType: LessonType;
  LessonUpdateInput: LessonUpdateInput;
  LessonUpdateManyInlineInput: LessonUpdateManyInlineInput;
  LessonUpdateManyInput: LessonUpdateManyInput;
  LessonUpdateManyWithNestedWhereInput: LessonUpdateManyWithNestedWhereInput;
  LessonUpdateOneInlineInput: LessonUpdateOneInlineInput;
  LessonUpdateWithNestedWhereUniqueInput: LessonUpdateWithNestedWhereUniqueInput;
  LessonUpsertInput: LessonUpsertInput;
  LessonUpsertWithNestedWhereUniqueInput: LessonUpsertWithNestedWhereUniqueInput;
  LessonWhereComparatorInput: LessonWhereComparatorInput;
  LessonWhereInput: LessonWhereInput;
  LessonWhereStageInput: LessonWhereStageInput;
  LessonWhereUniqueInput: LessonWhereUniqueInput;
  Locale: Locale;
  Location: ResolverTypeWrapper<Location>;
  LocationInput: LocationInput;
  Long: ResolverTypeWrapper<Scalars['Long']>;
  Mutation: ResolverTypeWrapper<{}>;
  Node: ResolversTypes['Asset'] | ResolversTypes['Challenge'] | ResolversTypes['Lesson'] | ResolversTypes['ScheduledOperation'] | ResolversTypes['ScheduledRelease'] | ResolversTypes['Subscriber'] | ResolversTypes['Teacher'] | ResolversTypes['User'];
  ...
  ScheduledOperationAffectedDocument: ResolversTypes['Asset'] | ResolversTypes['Challenge'] | ResolversTypes['Lesson'] | ResolversTypes['Subscriber'] | ResolversTypes['Teacher'];
  ...
  SubscriberConnectInput: SubscriberConnectInput;
  SubscriberConnection: ResolverTypeWrapper<SubscriberConnection>;
  SubscriberCreateInput: SubscriberCreateInput;
  SubscriberCreateManyInlineInput: SubscriberCreateManyInlineInput;
  SubscriberCreateOneInlineInput: SubscriberCreateOneInlineInput;
  SubscriberEdge: ResolverTypeWrapper<SubscriberEdge>;
  SubscriberManyWhereInput: SubscriberManyWhereInput;
  SubscriberOrderByInput: SubscriberOrderByInput;
  SubscriberUpdateInput: SubscriberUpdateInput;
  SubscriberUpdateManyInlineInput: SubscriberUpdateManyInlineInput;
  SubscriberUpdateManyInput: SubscriberUpdateManyInput;
  SubscriberUpdateManyWithNestedWhereInput: SubscriberUpdateManyWithNestedWhereInput;
  SubscriberUpdateOneInlineInput: SubscriberUpdateOneInlineInput;
  SubscriberUpdateWithNestedWhereUniqueInput: SubscriberUpdateWithNestedWhereUniqueInput;
  SubscriberUpsertInput: SubscriberUpsertInput;
  SubscriberUpsertWithNestedWhereUniqueInput: SubscriberUpsertWithNestedWhereUniqueInput;
  SubscriberWhereComparatorInput: SubscriberWhereComparatorInput;
  SubscriberWhereInput: SubscriberWhereInput;
  SubscriberWhereStageInput: SubscriberWhereStageInput;
  SubscriberWhereUniqueInput: SubscriberWhereUniqueInput;
  SystemDateTimeFieldVariation: SystemDateTimeFieldVariation;
  Teacher: ResolverTypeWrapper<Teacher>;
  TeacherConnectInput: TeacherConnectInput;
  TeacherConnection: ResolverTypeWrapper<TeacherConnection>;
  TeacherCreateInput: TeacherCreateInput;
  TeacherCreateManyInlineInput: TeacherCreateManyInlineInput;
  TeacherCreateOneInlineInput: TeacherCreateOneInlineInput;
  TeacherEdge: ResolverTypeWrapper<TeacherEdge>;
  TeacherManyWhereInput: TeacherManyWhereInput;
  TeacherOrderByInput: TeacherOrderByInput;
  TeacherUpdateInput: TeacherUpdateInput;
  TeacherUpdateManyInlineInput: TeacherUpdateManyInlineInput;
  TeacherUpdateManyInput: TeacherUpdateManyInput;
  TeacherUpdateManyWithNestedWhereInput: TeacherUpdateManyWithNestedWhereInput;
  TeacherUpdateOneInlineInput: TeacherUpdateOneInlineInput;
  TeacherUpdateWithNestedWhereUniqueInput: TeacherUpdateWithNestedWhereUniqueInput;
  TeacherUpsertInput: TeacherUpsertInput;
  TeacherUpsertWithNestedWhereUniqueInput: TeacherUpsertWithNestedWhereUniqueInput;
  TeacherWhereComparatorInput: TeacherWhereComparatorInput;
  TeacherWhereInput: TeacherWhereInput;
  TeacherWhereStageInput: TeacherWhereStageInput;
...
export type ResolversParentTypes = {
  ...
  Long: Scalars['Long'];
  Mutation: {};
  Node: ResolversParentTypes['Asset'] | ResolversParentTypes['Challenge'] | ResolversParentTypes['Lesson'] | ResolversParentTypes['ScheduledOperation'] | ResolversParentTypes['ScheduledRelease'] | ResolversParentTypes['Subscriber'] | ResolversParentTypes['Teacher'] | ResolversParentTypes['User'];
  PageInfo: PageInfo;
  PublishLocaleInput: PublishLocaleInput;
  Query: {};
  RGBA: Rgba;
  ...
  ScheduledOperationAffectedDocument: ResolversParentTypes['Asset'] | ResolversParentTypes['Challenge'] | ResolversParentTypes['Lesson'] | ResolversParentTypes['Subscriber'] | ResolversParentTypes['Teacher'];
  ScheduledOperationConnectInput: ScheduledOperationConnectInput;
...
export type ChallengeResolvers<ContextType = any, ParentType extends ResolversParentTypes['Challenge'] = ResolversParentTypes['Challenge']> = {
  ...
  createdBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<ChallengeCreatedByArgs>>;
  documentInStages?: Resolver<Array<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<ChallengeDocumentInStagesArgs, 'includeCurrent' | 'inheritLocale' | 'stages'>>;
  history?: Resolver<Array<ResolversTypes['Version']>, ParentType, ContextType, RequireFields<ChallengeHistoryArgs, 'limit' | 'skip'>>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  publishedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  publishedBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<ChallengePublishedByArgs>>;
  scheduledIn?: Resolver<Array<ResolversTypes['ScheduledOperation']>, ParentType, ContextType, Partial<ChallengeScheduledInArgs>>;
  stage?: Resolver<ResolversTypes['Stage'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  updatedBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<ChallengeUpdatedByArgs>>;
  url?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ChallengeConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ChallengeConnection'] = ResolversParentTypes['ChallengeConnection']> = {
  aggregate?: Resolver<ResolversTypes['Aggregate'], ParentType, ContextType>;
  edges?: Resolver<Array<ResolversTypes['ChallengeEdge']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ChallengeEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ChallengeEdge'] = ResolversParentTypes['ChallengeEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['Challenge'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type LessonResolvers<ContextType = any, ParentType extends ResolversParentTypes['Lesson'] = ResolversParentTypes['Lesson']> = {
  availableAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  challenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, Partial<LessonChallengeArgs>>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  createdBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<LessonCreatedByArgs>>;
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  documentInStages?: Resolver<Array<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<LessonDocumentInStagesArgs, 'includeCurrent' | 'inheritLocale' | 'stages'>>;
  history?: Resolver<Array<ResolversTypes['Version']>, ParentType, ContextType, RequireFields<LessonHistoryArgs, 'limit' | 'skip'>>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lessonType?: Resolver<ResolversTypes['LessonType'], ParentType, ContextType>;
  publishedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  publishedBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<LessonPublishedByArgs>>;
  scheduledIn?: Resolver<Array<ResolversTypes['ScheduledOperation']>, ParentType, ContextType, Partial<LessonScheduledInArgs>>;
  slug?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  stage?: Resolver<ResolversTypes['Stage'], ParentType, ContextType>;
  teacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, Partial<LessonTeacherArgs>>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  updatedBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<LessonUpdatedByArgs>>;
  videoId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LessonConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['LessonConnection'] = ResolversParentTypes['LessonConnection']> = {
  aggregate?: Resolver<ResolversTypes['Aggregate'], ParentType, ContextType>;
...
export type LessonEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['LessonEdge'] = ResolversParentTypes['LessonEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  createChallenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<MutationCreateChallengeArgs, 'data'>>;
  createLesson?: Resolver<Maybe<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<MutationCreateLessonArgs, 'data'>>;
  ...
  createSubscriber?: Resolver<Maybe<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<MutationCreateSubscriberArgs, 'data'>>;
  createTeacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<MutationCreateTeacherArgs, 'data'>>;
  deleteAsset?: Resolver<Maybe<ResolversTypes['Asset']>, ParentType, ContextType, RequireFields<MutationDeleteAssetArgs, 'where'>>;
  deleteChallenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<MutationDeleteChallengeArgs, 'where'>>;
  deleteLesson?: Resolver<Maybe<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<MutationDeleteLessonArgs, 'where'>>;
  ...
  deleteManyChallenges?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, Partial<MutationDeleteManyChallengesArgs>>;
  deleteManyChallengesConnection?: Resolver<ResolversTypes['ChallengeConnection'], ParentType, ContextType, Partial<MutationDeleteManyChallengesConnectionArgs>>;
  deleteManyLessons?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, Partial<MutationDeleteManyLessonsArgs>>;
  deleteManyLessonsConnection?: Resolver<ResolversTypes['LessonConnection'], ParentType, ContextType, Partial<MutationDeleteManyLessonsConnectionArgs>>;
  deleteManySubscribers?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, Partial<MutationDeleteManySubscribersArgs>>;
  deleteManySubscribersConnection?: Resolver<ResolversTypes['SubscriberConnection'], ParentType, ContextType, Partial<MutationDeleteManySubscribersConnectionArgs>>;
  deleteManyTeachers?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, Partial<MutationDeleteManyTeachersArgs>>;
  deleteManyTeachersConnection?: Resolver<ResolversTypes['TeacherConnection'], ParentType, ContextType, Partial<MutationDeleteManyTeachersConnectionArgs>>;
  ...
  deleteSubscriber?: Resolver<Maybe<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<MutationDeleteSubscriberArgs, 'where'>>;
  deleteTeacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<MutationDeleteTeacherArgs, 'where'>>;
  ...
  publishChallenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<MutationPublishChallengeArgs, 'to' | 'where'>>;
  publishLesson?: Resolver<Maybe<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<MutationPublishLessonArgs, 'to' | 'where'>>;
  ...
  publishManyChallenges?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationPublishManyChallengesArgs, 'to'>>;
  publishManyChallengesConnection?: Resolver<ResolversTypes['ChallengeConnection'], ParentType, ContextType, RequireFields<MutationPublishManyChallengesConnectionArgs, 'from' | 'to'>>;
  publishManyLessons?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationPublishManyLessonsArgs, 'to'>>;
  publishManyLessonsConnection?: Resolver<ResolversTypes['LessonConnection'], ParentType, ContextType, RequireFields<MutationPublishManyLessonsConnectionArgs, 'from' | 'to'>>;
  publishManySubscribers?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationPublishManySubscribersArgs, 'to'>>;
  publishManySubscribersConnection?: Resolver<ResolversTypes['SubscriberConnection'], ParentType, ContextType, RequireFields<MutationPublishManySubscribersConnectionArgs, 'from' | 'to'>>;
  publishManyTeachers?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationPublishManyTeachersArgs, 'to'>>;
  publishManyTeachersConnection?: Resolver<ResolversTypes['TeacherConnection'], ParentType, ContextType, RequireFields<MutationPublishManyTeachersConnectionArgs, 'from' | 'to'>>;
  publishSubscriber?: Resolver<Maybe<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<MutationPublishSubscriberArgs, 'to' | 'where'>>;
  publishTeacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<MutationPublishTeacherArgs, 'to' | 'where'>>;
  ...
  schedulePublishChallenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<MutationSchedulePublishChallengeArgs, 'to' | 'where'>>;
  schedulePublishLesson?: Resolver<Maybe<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<MutationSchedulePublishLessonArgs, 'to' | 'where'>>;
  schedulePublishSubscriber?: Resolver<Maybe<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<MutationSchedulePublishSubscriberArgs, 'to' | 'where'>>;
  schedulePublishTeacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<MutationSchedulePublishTeacherArgs, 'to' | 'where'>>;
  ...
  scheduleUnpublishChallenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<MutationScheduleUnpublishChallengeArgs, 'from' | 'where'>>;
  scheduleUnpublishLesson?: Resolver<Maybe<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<MutationScheduleUnpublishLessonArgs, 'from' | 'where'>>;
  scheduleUnpublishSubscriber?: Resolver<Maybe<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<MutationScheduleUnpublishSubscriberArgs, 'from' | 'where'>>;
  scheduleUnpublishTeacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<MutationScheduleUnpublishTeacherArgs, 'from' | 'where'>>;
  ...
  unpublishChallenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<MutationUnpublishChallengeArgs, 'from' | 'where'>>;
  unpublishLesson?: Resolver<Maybe<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<MutationUnpublishLessonArgs, 'from' | 'where'>>;
  ...
  unpublishManyChallenges?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationUnpublishManyChallengesArgs, 'from'>>;
  unpublishManyChallengesConnection?: Resolver<ResolversTypes['ChallengeConnection'], ParentType, ContextType, RequireFields<MutationUnpublishManyChallengesConnectionArgs, 'from' | 'stage'>>;
  unpublishManyLessons?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationUnpublishManyLessonsArgs, 'from'>>;
  unpublishManyLessonsConnection?: Resolver<ResolversTypes['LessonConnection'], ParentType, ContextType, RequireFields<MutationUnpublishManyLessonsConnectionArgs, 'from' | 'stage'>>;
  unpublishManySubscribers?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationUnpublishManySubscribersArgs, 'from'>>;
  unpublishManySubscribersConnection?: Resolver<ResolversTypes['SubscriberConnection'], ParentType, ContextType, RequireFields<MutationUnpublishManySubscribersConnectionArgs, 'from' | 'stage'>>;
  unpublishManyTeachers?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationUnpublishManyTeachersArgs, 'from'>>;
  unpublishManyTeachersConnection?: Resolver<ResolversTypes['TeacherConnection'], ParentType, ContextType, RequireFields<MutationUnpublishManyTeachersConnectionArgs, 'from' | 'stage'>>;
  unpublishSubscriber?: Resolver<Maybe<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<MutationUnpublishSubscriberArgs, 'from' | 'where'>>;
  unpublishTeacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<MutationUnpublishTeacherArgs, 'from' | 'where'>>;
  updateAsset?: Resolver<Maybe<ResolversTypes['Asset']>, ParentType, ContextType, RequireFields<MutationUpdateAssetArgs, 'data' | 'where'>>;
  updateChallenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<MutationUpdateChallengeArgs, 'data' | 'where'>>;
  updateLesson?: Resolver<Maybe<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<MutationUpdateLessonArgs, 'data' | 'where'>>;
  ...
  updateManyChallenges?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationUpdateManyChallengesArgs, 'data'>>;
  updateManyChallengesConnection?: Resolver<ResolversTypes['ChallengeConnection'], ParentType, ContextType, RequireFields<MutationUpdateManyChallengesConnectionArgs, 'data'>>;
  updateManyLessons?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationUpdateManyLessonsArgs, 'data'>>;
  updateManyLessonsConnection?: Resolver<ResolversTypes['LessonConnection'], ParentType, ContextType, RequireFields<MutationUpdateManyLessonsConnectionArgs, 'data'>>;
  updateManySubscribers?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationUpdateManySubscribersArgs, 'data'>>;
  updateManySubscribersConnection?: Resolver<ResolversTypes['SubscriberConnection'], ParentType, ContextType, RequireFields<MutationUpdateManySubscribersConnectionArgs, 'data'>>;
  updateManyTeachers?: Resolver<ResolversTypes['BatchPayload'], ParentType, ContextType, RequireFields<MutationUpdateManyTeachersArgs, 'data'>>;
  updateManyTeachersConnection?: Resolver<ResolversTypes['TeacherConnection'], ParentType, ContextType, RequireFields<MutationUpdateManyTeachersConnectionArgs, 'data'>>;
  ...
  updateSubscriber?: Resolver<Maybe<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<MutationUpdateSubscriberArgs, 'data' | 'where'>>;
  updateTeacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<MutationUpdateTeacherArgs, 'data' | 'where'>>;
  ...
  upsertChallenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<MutationUpsertChallengeArgs, 'upsert' | 'where'>>;
  upsertLesson?: Resolver<Maybe<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<MutationUpsertLessonArgs, 'upsert' | 'where'>>;
  upsertSubscriber?: Resolver<Maybe<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<MutationUpsertSubscriberArgs, 'upsert' | 'where'>>;
  upsertTeacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<MutationUpsertTeacherArgs, 'upsert' | 'where'>>;
};

export type NodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = {
  __resolveType: TypeResolveFn<'Asset' | 'Challenge' | 'Lesson' | 'ScheduledOperation' | 'ScheduledRelease' | 'Subscriber' | 'Teacher' | 'User', ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  stage?: Resolver<ResolversTypes['Stage'], ParentType, ContextType>;
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  challenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<QueryChallengeArgs, 'locales' | 'stage' | 'where'>>;
  challengeVersion?: Resolver<Maybe<ResolversTypes['DocumentVersion']>, ParentType, ContextType, RequireFields<QueryChallengeVersionArgs, 'where'>>;
  challenges?: Resolver<Array<ResolversTypes['Challenge']>, ParentType, ContextType, RequireFields<QueryChallengesArgs, 'locales' | 'stage'>>;
  challengesConnection?: Resolver<ResolversTypes['ChallengeConnection'], ParentType, ContextType, RequireFields<QueryChallengesConnectionArgs, 'locales' | 'stage'>>;
  lesson?: Resolver<Maybe<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<QueryLessonArgs, 'locales' | 'stage' | 'where'>>;
  lessonVersion?: Resolver<Maybe<ResolversTypes['DocumentVersion']>, ParentType, ContextType, RequireFields<QueryLessonVersionArgs, 'where'>>;
  lessons?: Resolver<Array<ResolversTypes['Lesson']>, ParentType, ContextType, RequireFields<QueryLessonsArgs, 'locales' | 'stage'>>;
  lessonsConnection?: Resolver<ResolversTypes['LessonConnection'], ParentType, ContextType, RequireFields<QueryLessonsConnectionArgs, 'locales' | 'stage'>>;
  ...
  subscriber?: Resolver<Maybe<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<QuerySubscriberArgs, 'locales' | 'stage' | 'where'>>;
  subscriberVersion?: Resolver<Maybe<ResolversTypes['DocumentVersion']>, ParentType, ContextType, RequireFields<QuerySubscriberVersionArgs, 'where'>>;
  subscribers?: Resolver<Array<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<QuerySubscribersArgs, 'locales' | 'stage'>>;
  subscribersConnection?: Resolver<ResolversTypes['SubscriberConnection'], ParentType, ContextType, RequireFields<QuerySubscribersConnectionArgs, 'locales' | 'stage'>>;
  teacher?: Resolver<Maybe<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<QueryTeacherArgs, 'locales' | 'stage' | 'where'>>;
  teacherVersion?: Resolver<Maybe<ResolversTypes['DocumentVersion']>, ParentType, ContextType, RequireFields<QueryTeacherVersionArgs, 'where'>>;
  teachers?: Resolver<Array<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<QueryTeachersArgs, 'locales' | 'stage'>>;
  teachersConnection?: Resolver<ResolversTypes['TeacherConnection'], ParentType, ContextType, RequireFields<QueryTeachersConnectionArgs, 'locales' | 'stage'>>;
...
export type ScheduledOperationAffectedDocumentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ScheduledOperationAffectedDocument'] = ResolversParentTypes['ScheduledOperationAffectedDocument']> = {
  __resolveType: TypeResolveFn<'Asset' | 'Challenge' | 'Lesson' | 'Subscriber' | 'Teacher', ParentType, ContextType>;
};
...
export type SubscriberResolvers<ContextType = any, ParentType extends ResolversParentTypes['Subscriber'] = ResolversParentTypes['Subscriber']> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  createdBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<SubscriberCreatedByArgs>>;
  documentInStages?: Resolver<Array<ResolversTypes['Subscriber']>, ParentType, ContextType, RequireFields<SubscriberDocumentInStagesArgs, 'includeCurrent' | 'inheritLocale' | 'stages'>>;
  email?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  history?: Resolver<Array<ResolversTypes['Version']>, ParentType, ContextType, RequireFields<SubscriberHistoryArgs, 'limit' | 'skip'>>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  publishedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  publishedBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<SubscriberPublishedByArgs>>;
  scheduledIn?: Resolver<Array<ResolversTypes['ScheduledOperation']>, ParentType, ContextType, Partial<SubscriberScheduledInArgs>>;
  stage?: Resolver<ResolversTypes['Stage'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  updatedBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<SubscriberUpdatedByArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type TeacherResolvers<ContextType = any, ParentType extends ResolversParentTypes['Teacher'] = ResolversParentTypes['Teacher']> = {
  ...
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  createdBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<TeacherCreatedByArgs>>;
  documentInStages?: Resolver<Array<ResolversTypes['Teacher']>, ParentType, ContextType, RequireFields<TeacherDocumentInStagesArgs, 'includeCurrent' | 'inheritLocale' | 'stages'>>;
  history?: Resolver<Array<ResolversTypes['Version']>, ParentType, ContextType, RequireFields<TeacherHistoryArgs, 'limit' | 'skip'>>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lessons?: Resolver<Array<ResolversTypes['Lesson']>, ParentType, ContextType, Partial<TeacherLessonsArgs>>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  publishedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  publishedBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<TeacherPublishedByArgs>>;
  scheduledIn?: Resolver<Array<ResolversTypes['ScheduledOperation']>, ParentType, ContextType, Partial<TeacherScheduledInArgs>>;
  stage?: Resolver<ResolversTypes['Stage'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  updatedBy?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, Partial<TeacherUpdatedByArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type TeacherConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['TeacherConnection'] = ResolversParentTypes['TeacherConnection']> = {
  aggregate?: Resolver<ResolversTypes['Aggregate'], ParentType, ContextType>;
  edges?: Resolver<Array<ResolversTypes['TeacherEdge']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TeacherEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['TeacherEdge'] = ResolversParentTypes['TeacherEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['Teacher'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type Resolvers<ContextType = any> = {
  ...
  ChallengeConnection?: ChallengeConnectionResolvers<ContextType>;
  ChallengeEdge?: ChallengeEdgeResolvers<ContextType>;
  ...
  TeacherEdge?: TeacherEdgeResolvers<ContextType>;
